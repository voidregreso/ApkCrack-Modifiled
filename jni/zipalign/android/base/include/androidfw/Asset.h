...
namespace android
{
    ...
    public:
         ...
         */
        const char *getAssetSource(void) const
        {
    ...
    protected:
        ...
        void setAssetSource(const String8 &path)
        {
            mAssetSource = path;
        }
    ...
    public:
        ...
        virtual off64_t getLength(void) const
        {
            return mLength;
        }
        virtual off64_t getRemainingLength(void) const
        {
